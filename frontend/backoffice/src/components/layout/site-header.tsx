...
/** CC-03: list pages own the page title via PageContainer h1 — header shows crumbs only for custom trails. */
function hasCustomBreadcrumbTrail(breadcrumb: SidebarBreadcrumb): boolean {
  return (breadcrumb.items?.length ?? 0) > 0;
}
...
export function SiteHeader({
  ...
  const customItems = breadcrumb.items;
