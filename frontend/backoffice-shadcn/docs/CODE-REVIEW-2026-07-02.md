...
**`git diff --stat HEAD` (backoffice-shadcn + siblings in same working tree):** 35 files, +1074 / −637 lines (includes out-of-scope backend/agent-invoice and AntD sibling).
