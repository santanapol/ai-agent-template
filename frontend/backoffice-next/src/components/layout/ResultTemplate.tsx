import { CheckCircle2, FileQuestion, type LucideIcon, ServerCrash, ShieldX } from "lucide-react";
...
const STATUS_CONFIG: Record<ResultStatus, { icon: LucideIcon; iconClassName: string }> = {
...
const ResultTemplate: React.FC<ResultTemplateProps> = ({
  ...
  const resultExtra = extra ?? <Button onClick={onPrimaryAction}>{primaryActionText}</Button>;
