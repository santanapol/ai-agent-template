...
const mockToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMiLCJyb2xlIjoicGxhdGZvcm1fYWRtaW4iLCJleHAiOjE5MjQ5OTk5OTl9.signature";
...
describe("AuthContext", () => {
  ...
  test("reloads menus after token refresh when user session is restored (SC-3)", async () => {
    ...
    mockedGetMyMenus.mockResolvedValueOnce(menusWithInvoices).mockResolvedValueOnce(menusWithoutInvoices);
