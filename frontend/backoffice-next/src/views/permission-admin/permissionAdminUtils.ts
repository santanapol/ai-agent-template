...
export function filterCheckedActionKeys(keys: string[], registry: AdminMenuNode[]): string[] {
...
export function expandRoleMappingToCheckedKeys(menuKeys: string[], registry: AdminMenuNode[]): string[] {
...
export function buildRoleSaveMenuKeys(role: string, checkedExact: string[], wildcards: string[]): string[] {
...
export function isPlatformAdminManageCheckboxDisabled(role: string, key: string, wildcards: string[]): boolean {
