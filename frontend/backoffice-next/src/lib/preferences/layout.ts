...
export const LAYOUT_OPTIONS = {
  sidebar_variant: SIDEBAR_VARIANT_OPTIONS,
  sidebar_collapsible: SIDEBAR_COLLAPSIBLE_OPTIONS,
  content_layout: CONTENT_LAYOUT_OPTIONS,
  navbar_style: NAVBAR_STYLE_OPTIONS,
} as const;
