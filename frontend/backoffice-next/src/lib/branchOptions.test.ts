...
describe("branchOptions", () => {
  ...
  it("findInvoiceAgentBranch returns matching branch", () => {
    const branches: InvoiceAgentBranch[] = [{ branch_id: "a", branch_name: "A", branch_code: "A01", active: true }];
  ...
  it("formatBranchDisplayLabel resolves known branch or falls back while loading", () => {
    const branches: InvoiceAgentBranch[] = [{ branch_id: "a", branch_name: "777WW", branch_code: "7W", active: true }];
  ...
  it("resolveInvoiceFilterBranches prefers fresh API data over cache", () => {
    const cached: InvoiceAgentBranch[] = [{ branch_id: "old", branch_name: "Old", branch_code: "OLD", active: true }];
    const fresh: InvoiceAgentBranch[] = [{ branch_id: "new", branch_name: "New", branch_code: "NEW", active: true }];
