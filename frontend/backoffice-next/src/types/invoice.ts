export type InvoiceStatus = "PENDING" | "VOID" | "CAL" | "MISSING_FEE" | "READY" | "ERROR" | "PAID";

export const INVOICE_STATUSES: InvoiceStatus[] = ["PENDING", "VOID", "CAL", "MISSING_FEE", "READY", "ERROR", "PAID"];
