...
└── docs/deploy/digitalocean.md   # GitHub Actions CI/CD to DigitalOcean
```
...
| **Deployment** | [docs/deploy/digitalocean.md](./docs/deploy/digitalocean.md) | GitHub Actions CI/CD to DigitalOcean |
