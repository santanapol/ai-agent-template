...
usage() {
  cat <<'EOF'
Usage: ./scripts/agent/sync-agent-skills.sh [UPSTREAM_PATH]
...
3. Appends Related Coding Standards from scripts/agent/agent-skills-standards/<command>.md
...
**Generated** by [`../../scripts/agent/sync-agent-skills.sh`](../../scripts/agent/sync-agent-skills.sh) — upstream English + [agent-skills-standards](../../scripts/agent/agent-skills-standards/).

| Command | Standards |
|---------|-----------|
| `/spec` | [spec.md](../../scripts/agent/agent-skills-standards/spec.md) |
| `/plan` | [plan.md](../../scripts/agent/agent-skills-standards/plan.md) |
| `/build` | [build.md](../../scripts/agent/agent-skills-standards/build.md) |
| `/code-build` | alias of `/build` |
| `/test` | [test.md](../../scripts/agent/agent-skills-standards/test.md) |
| `/review` | [review.md](../../scripts/agent/agent-skills-standards/review.md) |
| `/webperf` | [webperf.md](../../scripts/agent/agent-skills-standards/webperf.md) |
| `/code-simplify` | [code-simplify.md](../../scripts/agent/agent-skills-standards/code-simplify.md) |
...
**Generated** by [`../scripts/agent/sync-agent-skills.sh`](../scripts/agent/sync-agent-skills.sh) — upstream native format + [agent-skills-standards](../scripts/agent/agent-skills-standards/).
...
echo "Edit standards only: scripts/agent/agent-skills-standards/<command>.md"
