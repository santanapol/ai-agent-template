...
| backoffice | A- | yes | partial | no | Biome lint 0 errors; SmartReport server pagination; invoice URL sync; review fixes shipped |
...
4. **P3** — Add product spec index entry for backoffice under `docs/specs/frontend/`

## Last updated

2026-07-08 — backoffice-next review fixes: lint gate, invoice URL sync, export bundle, apiError hardening, SmartReport pagination.
