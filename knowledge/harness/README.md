...
สารบัญสั้น: [AGENTS.md](../AGENTS.md) · กฎเชิงกลไก: [golden-principles.md](../docs/golden-principles.md) · Template: [docs/TEMPLATE.md](../docs/TEMPLATE.md)
...
| `references/`, root `CLAUDE.md` | `knowledge/harness/` (แนวคิดนี้) |
...
knowledge/                   ← harness + testing standards
coding-standard/             ← org build rules (auth, gateway, backend, frontend)
