...
## 📌 คืออะไร
ตรวจสอบว่าระบบใช้งานได้กับทุกกลุ่มผู้ใช้ รวมถึงผู้พิการทางสายตาหรือผู้ที่ใช้คีย์บอร์ดเพียงอย่างเดียว (Screen Reader, Keyboard navigation)
...
## 🔥 ความจำเป็น
⭐️ **Optional** — ขึ้นอยู่กับ Target User และกฎหมายของแต่ละประเทศ
