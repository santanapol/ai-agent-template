...
export function listItems(query, userContext) {
  return repository.listItems(query, userContext);
}

export function createItem(body, userContext, routeTemplate) {
...
export async function getItemById(itemId, userContext) {
...
export async function deleteItem(itemId, userContext, ifMatch) {
  const ifMatchDate = parseIfMatch(ifMatch);
