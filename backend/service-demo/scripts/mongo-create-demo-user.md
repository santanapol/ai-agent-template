...
db.createRole({
  ...
  privileges: [
    {
      resource: { db: "service-demo", collection: "items" },
      actions: [
        "find",
        "insert",
        "update",
...
db.createUser({
  user: "demo-service",
  pwd: "demo-service",
  roles: [{ role: "demo_service_role", db: "service-demo" }],
})
```
...
MONGODB_URI=mongodb://demo-service:demo-service@localhost:27017/service-demo?authSource=service-demo
```
