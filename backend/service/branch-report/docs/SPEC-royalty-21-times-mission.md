...
### Backend (`backend/service/branch-report/`)
...
### Frontend (`frontend/backoffice-next/`)
...
├── docs/
│   ├── SPEC-royalty-21-times-mission.md
│   └── SPEC-deposit-matrix-tabs.md
├── src/
│   ├── config/
...
├── lib/
│   └── branchReportApiClient.ts        # API client
├── types/
│   └── branchReport.ts
└── app/                                # App Router routes + menu meta
```
...
- [x] Plan written → [deposit-matrix-ship-fixup-2026-07.md](../../../../docs/exec-plans/completed/deposit-matrix-ship-fixup-2026-07.md) — phase 1
- [x] **Reg-date amendment reviewed** (2026-06-29)
- [x] **Assumptions confirmed** (local month default; lifetime metrics)
- [x] **Reg-date plan approved** → Phase 7 in exec-plans (archived)
