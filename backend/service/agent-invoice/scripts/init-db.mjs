...
async function run() {
  ...
  await feesCol.createIndex(
    ...
    { unique: true, background: true, name: "ou_id_1_branch_id_1_game_company_id_1_game_main_cate_id_1" },
  );
  console.log("  ✔ agent_fees: ou_id_1_branch_id_1_game_company_id_1_game_main_cate_id_1");
