...
Read and follow **testcase-authoring** (`.cursor/skills/testcase-authoring/SKILL.md`) completely — including `harness/references/` (repo discovery, techniques, bug-hunt).
