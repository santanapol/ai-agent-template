...
- For detailed security review guidance, see `harness/references/security-checklist.md`
- For performance review checks, see `harness/references/performance-checklist.md`
