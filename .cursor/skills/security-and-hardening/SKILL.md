...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `harness/references/security-checklist.md`.
...
For detailed security checklists and pre-commit verification steps, see `harness/references/security-checklist.md`.
