...
- `Members`
- `Settings` → **`/ou/:ouId/settings`** (OU-level; `RoleGuard` จำกัด owner/admin)

### แนวทางเต็ม (ระยะยาว / deferred)

- `Dashboard`, `Items`, `Reports`, `Billing`, `Admin`, `Help` — เก็บเป็นแนว IA ด้านล่างเมื่อขยาย product scope
