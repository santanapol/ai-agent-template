...
export function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      void navigate(`/ou/${next.ouId}/branches/${next.branchId}/members`, {
        replace: true,
      });
    } catch (err) {
    ...
    <section>
      ...
      {isSignedIn ? (
        <div className="panel">
          ...
          <p>
            <Link
              to={`/ou/${session.ouId}/branches/${session.branchId}/members`}
            >
              Go to members
            </Link>
          </p>
      ...
      <p>
        <Link to="/ou/ou-001/branches/bkk-01/members">
